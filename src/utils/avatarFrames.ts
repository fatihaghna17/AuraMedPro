...
export const AVATAR_FRAMES: AvatarFrame[] = [
  ...
  },
  {
    ...
    isUnlocked: (stats) => (stats.todayQuestions !== undefined && stats.todayQuestions >= 500) || isQuest500Completed()
  },
  {
    id: 'ekg_neon',
    ...
    isUnlocked: ({ totalQuestions }) => totalQuestions >= 1000
  },
  {
    ...
    requirementText: 'Capai Streak ≥ 10 di Mode Sudden Death',
    rarity: 'legendary',
    ...
    auraClass: 'border-rose-500 shadow-lg shadow-rose-600/50',
    isUnlocked: ({ suddenDeathBest }) => suddenDeathBest >= 10
  },
  {
    id: 'veteran_3000',
    ...
    isUnlocked: ({ totalQuestions }) => totalQuestions >= 3000
  },
  {
    id: 'caduceus_mythic',
